...
const PLACES: Place[] = [
  ...
  { id: 'back-yard',      name: 'backyard',       color: '#7B5CC4' },
  { id: '5k-run',         name: '5k run',         color: '#C97A4A' },
];

const CLASSES: ClassSession[] = [
  // strength gym
  { id: 'sg-1', placeId: 'strength-gym', title: 'calisthenics (pull-up clinic)', time: '2:00 – 2:50 pm', totalSlots: 25, slotsTaken: 18, coach: 'the 1 pull up club',    coachBio: 'beginners’ calisthenics community. for every person and every body — scaled drills, prioritising new movers.',                                  coachPhoto: '/images/photos/athlete-barbell-grip-smiling.jpg',      description: 'the 1 pull up club is a beginners calisthenics community. suitable for all levels, beginners are prioritised — for every person, and every body. this session focuses on building toward your first pull-up.', duration: '50 min', level: 'all levels', instagram: '1puclub' },
  { id: 'sg-2', placeId: 'strength-gym', title: 'mobility',   time: '3:00 – 3:50 pm', totalSlots: 25, slotsTaken: 12, coach: 'edgar',   coachBio: 'coming from a line of dance, visual art, fashion, yoga, hiit and somatic practices, edgar (they/she) has been engaging with bodies on many different levels and layers. finishing up their studies in „dance, choreography, context” while simultaneously coaching boxing, hiit and strength training — they’ve spent the last five years understanding movement and how to train a body that is strong and fast while remaining flexible, open and aware. this way we can meet the world and each other in a more connected way: strong but not rigid, soft but not weak, grounded but not isolated.',          coachPhoto: '/images/photos/athlete-laughing-post-workout.jpg',     description: 'a guided mobility session designed to help you move, stretch, and recover. expect a combination of joint mobility, dynamic stretching, and controlled movement exercises that improve flexibility, release tension, and leave you feeling more open and refreshed.',         duration: '50 min', level: 'all levels', instagram: 'edgar.mauser' },
  { id: 'sg-3', placeId: 'strength-gym', title: 'calisthenics (handstand clinic)', time: '4:00 – 4:50 pm', totalSlots: 25, slotsTaken: 9,  coach: 'the 1 pull up club',    coachBio: 'beginners’ calisthenics community. for every person and every body — scaled drills, prioritising new movers.',                                  coachPhoto: '/images/photos/athlete-barbell-grip-smiling.jpg',      description: 'the 1 pull up club is a beginners calisthenics community. suitable for all levels, beginners are prioritised — for every person, and every body. this session focuses on the fundamentals of the handstand.',  duration: '50 min', level: 'intermediate', instagram: '1puclub' },
  { id: 'sg-4', placeId: 'strength-gym', title: 'mobility',   time: '5:00 – 5:50 pm', totalSlots: 25, slotsTaken: 14, coach: 'edgar',   coachBio: 'coming from a line of dance, visual art, fashion, yoga, hiit and somatic practices, edgar (they/she) has been engaging with bodies on many different levels and layers. finishing up their studies in „dance, choreography, context” while simultaneously coaching boxing, hiit and strength training — they’ve spent the last five years understanding movement and how to train a body that is strong and fast while remaining flexible, open and aware. this way we can meet the world and each other in a more connected way: strong but not rigid, soft but not weak, grounded but not isolated.',          coachPhoto: '/images/photos/athlete-laughing-post-workout.jpg',     description: 'a guided mobility session designed to help you move, stretch, and recover. expect a combination of joint mobility, dynamic stretching, and controlled movement exercises that improve flexibility, release tension, and leave you feeling more open and refreshed.',                          duration: '50 min', level: 'all levels', instagram: 'edgar.mauser' },

  // movement gym
  { id: 'mg-1', placeId: 'movement-gym', title: 'dopamine boxing', time: '3:00 – 3:50 pm', totalSlots: 24, slotsTaken: 16, coach: 'sidney rosa', coachBio: 'rio 2016 olympian. reigning two-time latin american champion. over a decade of coaching boxers across the globe, sidney builds you from the ground up, footwork and stance before fury, technique before ego. the real foundations, taught by someone who knows exactly what he’s doing.',   coachPhoto: '/images/photos/teammates-barbell-rack-dopamine-tees.jpg', description: 'whether you’ve never thrown a punch or you’ve been training for years, this class is built for you. beginners get the real foundations: stance, the 1–6 punches, defence, and footwork — broken down by coaches who actually box. experienced practitioners get the repetition that keeps technique sharp and the high-intensity padwork that makes this one of the best cardio sessions you’ll find anywhere. no ego. no experience required. just real boxing. gloves provided.', duration: '50 min', level: 'all levels', instagram: 'tbd' },
  ...
  // clubhouse
  { id: 'ch-1', placeId: 'clubhouse', title: 'les mills — bodypump',    time: '2:00 – 2:50 pm', totalSlots: 30, slotsTaken: 30, coach: 'les mills team', coachBio: 'globally certified instructors rotating through every session, part of a 100,000-strong worldwide community. trained on the exact choreography, music, and cueing — they bring the energy, you bring the reps. expect motivating coaching, scaling for every level, and a room that moves together.',                  coachPhoto: '/images/photos/LesMillsxSportsbase_142.jpg',     description: 'the original barbell class. ten tracks, 1,000+ reps in 50 minutes, every major muscle group hit with squats, presses, and deadlifts. science-backed moves, scaling options for every level — high energy, low impact, suitable for everyone.', duration: '50 min', level: 'all levels', instagram: 'tbd' },
  { id: 'ch-2', placeId: 'clubhouse', title: 'les mills — bodycombat',  time: '3:00 – 3:50 pm', totalSlots: 30, slotsTaken: 19, coach: 'les mills team', coachBio: 'globally certified instructors rotating through every session, part of a 100,000-strong worldwide community. trained on the exact choreography, music, and cueing — they bring the energy, you bring the reps. expect motivating coaching, scaling for every level, and a room that moves together.',                  coachPhoto: '/images/photos/LesMillsxSportsbase_196 (3).jpg', description: 'fierce, non-contact cardio inspired by martial arts. punch, kick, sweat, repeat.',                                    duration: '50 min', level: 'all levels', instagram: 'tbd' },
  { id: 'run-1', placeId: '5k-run', title: '5k run',                       time: '4:00 – 4:50 pm', totalSlots: 80, slotsTaken: 22, coach: 'blend kollektiv', coachBio: 'berlin-based running collective focused on a fun and friendly environment.',           coachPhoto: '/images/photos/women-sprinting-close-up.jpg',    description: 'outdoor 5k in treptower park. any pace is welcome. focus is on fun and connections.', duration: '50 min', level: 'all levels', instagram: 'blendkollektiv' },
  { id: 'ch-4', placeId: 'clubhouse', title: 'les mills — bodypump',    time: '5:00 – 5:50 pm', totalSlots: 30, slotsTaken: 8,  coach: 'les mills team', coachBio: 'globally certified instructors rotating through every session, part of a 100,000-strong worldwide community. trained on the exact choreography, music, and cueing — they bring the energy, you bring the reps. expect motivating coaching, scaling for every level, and a room that moves together.',                  coachPhoto: '/images/photos/LesMillsxSportsbase_142.jpg',     description: 'the original barbell class. ten tracks, 1,000+ reps in 50 minutes, every major muscle group hit with squats, presses, and deadlifts. science-backed moves, scaling options for every level — high energy, low impact, suitable for everyone.', duration: '50 min', level: 'all levels', instagram: 'tbd' },
  { id: 'ch-5', placeId: 'clubhouse', title: 'pxbj — hiphop foundations',         time: '6:00 – 6:50 pm', totalSlots: 30, slotsTaken: 17, coach: 'jamie-ann lang',       coachBio: 'founder of pxbj, professional choreographer, and movement coach. jamie blends strong hip hop foundations with performance quality, confidence-building, and real artistic development.', coachPhoto: '/images/photos/duo-assault-bike-recovery.jpg',   description: 'a beginner-friendly dance experience tailored for the games — a signature pxbj training experience building confidence, rhythm, performance skills, and authentic hip hop foundations. rooted in strong coaching, intense drills, and lots of fun, this class develops musicality, stage presence, and captivating choreography by founder jay while embodying the bold energy that defines every pxbj dance class.', duration: '50 min', level: 'all levels', instagram: 'pxbj.us' },

  // recovery zone — sauna & ice bathing, 30-min slots every half hour, 2pm – 6:30pm
  { id: 'rz-1', placeId: 'recovery-zone', title: 'sauna & ice bathing', time: '2:00 – 2:30 pm', totalSlots: 16, slotsTaken: 8,  coach: 'the dopamine team', coachBio: 'expert recovery coaches that live and breathe contrast therapy.', coachPhoto: '/images/photos/athletes-recovery-games-tee-rowers.jpg', description: 'a 30-minute contrast session — sauna heat and ice plunge.', duration: '30 min', level: 'all levels', instagram: 'tbd' },
  { id: 'rz-2', placeId: 'recovery-zone', title: 'sauna & ice bathing', time: '2:30 – 3:00 pm', totalSlots: 16, slotsTaken: 11, coach: 'the dopamine team', coachBio: 'expert recovery coaches that live and breathe contrast therapy.', coachPhoto: '/images/photos/athletes-recovery-games-tee-rowers.jpg', description: 'a 30-minute contrast session — sauna heat and ice plunge.', duration: '30 min', level: 'all levels', instagram: 'tbd' },
  { id: 'rz-3', placeId: 'recovery-zone', title: 'sauna & ice bathing', time: '3:00 – 3:30 pm', totalSlots: 16, slotsTaken: 9,  coach: 'the dopamine team', coachBio: 'expert recovery coaches that live and breathe contrast therapy.', coachPhoto: '/images/photos/athletes-recovery-games-tee-rowers.jpg', description: 'a 30-minute contrast session — sauna heat and ice plunge.', duration: '30 min', level: 'all levels', instagram: 'tbd' },
  { id: 'rz-4', placeId: 'recovery-zone', title: 'sauna & ice bathing', time: '3:30 – 4:00 pm', totalSlots: 16, slotsTaken: 12, coach: 'the dopamine team', coachBio: 'expert recovery coaches that live and breathe contrast therapy.', coachPhoto: '/images/photos/athletes-recovery-games-tee-rowers.jpg', description: 'a 30-minute contrast session — sauna heat and ice plunge.', duration: '30 min', level: 'all levels', instagram: 'tbd' },
  { id: 'rz-5', placeId: 'recovery-zone', title: 'sauna & ice bathing', time: '4:00 – 4:30 pm', totalSlots: 16, slotsTaken: 7,  coach: 'the dopamine team', coachBio: 'expert recovery coaches that live and breathe contrast therapy.', coachPhoto: '/images/photos/athletes-recovery-games-tee-rowers.jpg', description: 'a 30-minute contrast session — sauna heat and ice plunge.', duration: '30 min', level: 'all levels', instagram: 'tbd' },
  { id: 'rz-6', placeId: 'recovery-zone', title: 'sauna & ice bathing', time: '4:30 – 5:00 pm', totalSlots: 16, slotsTaken: 10, coach: 'the dopamine team', coachBio: 'expert recovery coaches that live and breathe contrast therapy.', coachPhoto: '/images/photos/athletes-recovery-games-tee-rowers.jpg', description: 'a 30-minute contrast session — sauna heat and ice plunge.', duration: '30 min', level: 'all levels', instagram: 'tbd' },
  { id: 'rz-7', placeId: 'recovery-zone', title: 'sauna & ice bathing', time: '5:00 – 5:30 pm', totalSlots: 16, slotsTaken: 14, coach: 'the dopamine team', coachBio: 'expert recovery coaches that live and breathe contrast therapy.', coachPhoto: '/images/photos/athletes-recovery-games-tee-rowers.jpg', description: 'a 30-minute contrast session — sauna heat and ice plunge.', duration: '30 min', level: 'all levels', instagram: 'tbd' },
  { id: 'rz-8', placeId: 'recovery-zone', title: 'sauna & ice bathing', time: '5:30 – 6:00 pm', totalSlots: 16, slotsTaken: 13, coach: 'the dopamine team', coachBio: 'expert recovery coaches that live and breathe contrast therapy.', coachPhoto: '/images/photos/athletes-recovery-games-tee-rowers.jpg', description: 'a 30-minute contrast session — sauna heat and ice plunge.', duration: '30 min', level: 'all levels', instagram: 'tbd' },
  { id: 'rz-9', placeId: 'recovery-zone', title: 'sauna & ice bathing', time: '6:00 – 6:30 pm', totalSlots: 16, slotsTaken: 5,  coach: 'the dopamine team', coachBio: 'expert recovery coaches that live and breathe contrast therapy.', coachPhoto: '/images/photos/athletes-recovery-games-tee-rowers.jpg', description: 'a 30-minute contrast session — sauna heat and ice plunge.', duration: '30 min', level: 'all levels', instagram: 'tbd' },

  // padel court
  { id: 'pc-1', placeId: 'paddle-court', title: 'padel pump', time: '2:00 – 2:50 pm', totalSlots: 18, slotsTaken: 10, coach: 'offcourt collective', coachBio: 'a berlin-based racket sports community blending tennis, padel, movement, music, and culture. we create social-first experiences on and off the court — focused on energy, connection, and fun over competition.', coachPhoto: '/images/photos/LesMillsxSportsbase_142.jpg',        description: 'join our open beginner-friendly session at adidas base. expect a fun mix of padel drills, movement, music, and social play — no experience needed. rackets provided. everyone welcome.',      duration: '50 min', level: 'all levels', instagram: 'offcourt_collective' },
  { id: 'pc-2', placeId: 'paddle-court', title: 'padel pump', time: '3:00 – 3:50 pm', totalSlots: 18, slotsTaken: 14, coach: 'offcourt collective', coachBio: 'a berlin-based racket sports community blending tennis, padel, movement, music, and culture. we create social-first experiences on and off the court — focused on energy, connection, and fun over competition.', coachPhoto: '/images/photos/LesMillsxSportsbase_196 (3).jpg',    description: 'join our open beginner-friendly session at adidas base. expect a fun mix of padel drills, movement, music, and social play — no experience needed. rackets provided. everyone welcome.',                                  duration: '50 min', level: 'all levels', instagram: 'offcourt_collective' },
  { id: 'pc-3', placeId: 'paddle-court', title: 'padel pump', time: '4:00 – 4:50 pm', totalSlots: 18, slotsTaken: 11, coach: 'offcourt collective', coachBio: 'a berlin-based racket sports community blending tennis, padel, movement, music, and culture. we create social-first experiences on and off the court — focused on energy, connection, and fun over competition.', coachPhoto: '/images/photos/athlete-sled-push-competition.jpg',  description: 'join our open beginner-friendly session at adidas base. expect a fun mix of padel drills, movement, music, and social play — no experience needed. rackets provided. everyone welcome.',   duration: '50 min', level: 'intermediate', instagram: 'offcourt_collective' },
  { id: 'pc-4', placeId: 'paddle-court', title: 'padel pump', time: '5:00 – 5:50 pm', totalSlots: 18, slotsTaken: 7,  coach: 'offcourt collective', coachBio: 'a berlin-based racket sports community blending tennis, padel, movement, music, and culture. we create social-first experiences on and off the court — focused on energy, connection, and fun over competition.', coachPhoto: '/images/photos/LesMillsxSportsbase_142.jpg',        description: 'join our open beginner-friendly session at adidas base. expect a fun mix of padel drills, movement, music, and social play — no experience needed. rackets provided. everyone welcome.',                              duration: '50 min', level: 'all levels', instagram: 'offcourt_collective' },

  // back yard
  { id: 'by-1', placeId: 'back-yard', title: 'beats & burpees', time: '6:00 – 6:50 pm', totalSlots: 100, slotsTaken: 26, coach: 'beats & burpees', coachBio: 'berlin-born hybrid training crew. hyrox and hiit sessions set to techno and house — workout meets whole experience.', coachPhoto: '/images/photos/athlete-assault-bike-intensity.jpg', description: 'welcome to beats & burpees. we combine strong hyrox and hiit sessions with techno and house music — it’s not only a workout, but a whole experience. closing event of the day.', duration: '50 min', level: 'all levels', instagram: 'beats.and.burpees' },
];
            ...
            return (
              ...
              >
                ...
                <div style={{ fontSize: 14, color: '#707070', display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <span style={{ color: '#141514', fontWeight: 600, fontFeatureSettings: '"liga" 0' }}>{c.coach}</span>
                </div>

                {/* availability */}
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 12, fontWeight: 500 }}>
                  <span style={{ color: isFull ? '#E8A53C' : fillPct >= 80 ? '#F78DB9' : '#707070' }}>
                    {isFull ? 'full' : fillPct >= 80 ? 'limited spots' : 'available'}
                  </span>
                  <span style={{ color: '#707070' }}>{c.duration}</span>
                </div>
          ...
          >
            ...
            <div style={{ padding: '28px 32px 32px' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, marginBottom: 24, fontSize: 13, color: '#707070' }}>
                ...
                <span>·</span>
                {(() => { const left = modalClass.totalSlots - modalClass.slotsTaken; const pct = (modalClass.slotsTaken / modalClass.totalSlots) * 100; const isFull = left <= 0; const isLimited = !isFull && pct >= 80; return <span style={{ color: isFull ? '#E8A53C' : isLimited ? '#F78DB9' : '#707070', fontWeight: 600 }}>{isFull ? 'full' : isLimited ? 'limited spots' : 'available'}</span>; })()}
              </div>

              {/* description */}
              <p style={{ fontSize: 15, color: '#141514', lineHeight: 1.65, margin: '0 0 28px', fontFeatureSettings: '"liga" 0' }}>
              ...
              <div style={{ borderTop: '1px solid #EFEFEF', paddingTop: 24, marginBottom: 28 }}>
                ...
                <div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 16, fontWeight: 700, color: '#141514', letterSpacing: '-0.01em', marginBottom: 4, fontFeatureSettings: '"liga" 0' }}>
                      {modalClass.coach}
                    </div>
                    <p style={{ fontSize: 13, color: '#707070', lineHeight: 1.55, margin: 0, fontFeatureSettings: '"liga" 0' }}>
                      {modalClass.coachBio}
                    </p>
